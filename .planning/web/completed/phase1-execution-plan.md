...
The 12 app-readiness criteria, mapped to: blocking dependencies, test vehicle, and current status. **No criterion text restated** — read the web readiness planning for the spec.
