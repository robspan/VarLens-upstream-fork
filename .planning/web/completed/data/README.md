...
Date: 2026-05-12
Status: first manifest-backed parity data harness implemented.

This folder records the data layer used for true desktop-vs-web parity E2E testing. The goal is developer clarity, not human-genetics expertise.
...
The implementation lives under `scripts/data-fixtures/`:
