...
Source: web readiness planning
Companion: [`desktop-preservation.md`](desktop-preservation.md) · [`README.md`](README.md)

Adds an executable gate for the 12 app readiness criteria under `tests/web-gate/`. Opt-in (`make web-gate-*`); excluded from default `make ci`.
...
| Assessment 1 / Assessment 3 | Doc gate, IaC repo |
