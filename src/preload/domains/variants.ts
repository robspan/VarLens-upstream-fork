...
export function createVariantsApi(): VariantsDomainContract {
  return {
    query: (caseId, filters, offset, limit, sortBy, skipCount, includeUnfilteredCount) =>
      ipcRenderer.invoke('variants:query', caseId, filters, offset, limit, sortBy, skipCount, includeUnfilteredCount),
    ...
    geneSymbols: (caseId, query, limit) => ipcRenderer.invoke('variants:geneSymbols', caseId, query, limit),
