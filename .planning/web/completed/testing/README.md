...
Mode toggle: see `AGENTS.md` § "Mode toggle". Companion: [`../../context/decisions/postgres-backend.md`](../../context/decisions/postgres-backend.md). Source plan: VarLens-IaC `.internalplanning/konzept/app.html` §app2.1.
