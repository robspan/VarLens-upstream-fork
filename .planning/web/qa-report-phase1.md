...
- No dangling `.planning/web/phase1-gate-tests.md` references (all rewritten to `.planning/web/testing/desktop-to-web-parity.md` earlier in the day).
- Handover checklist (`.planning/handover/README.md`) references the correct hook (`pre-commit`) and current file paths.
