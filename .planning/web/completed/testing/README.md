...
Mode toggle: see `AGENTS.md` § "Mode toggle". Companion: [`../../context/decisions/postgres-backend.md`](../../context/decisions/postgres-backend.md). Source: external Concept Pilot planning.
